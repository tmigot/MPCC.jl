...
function _sign_multipliers_comp_Sstat(pb::AbstractMPCCModel, state::MPCCAtX, actif::Float64)
...
function _sign_multipliers_comp_Mstat(pb::AbstractMPCCModel, state::MPCCAtX)
...
function _sign_multipliers_comp_Cstat(pb::AbstractMPCCModel, state::MPCCAtX)
