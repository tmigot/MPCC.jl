...
@test length(hessH_coord(bpmpcc, bpmpcc.meta.x0, zeros(2))) ==
      bpmpcc.meta.nvar * (bpmpcc.meta.nvar + 1) / 2
@test length(hessG_coord(bpmpcc, bpmpcc.meta.x0, zeros(2))) ==
      bpmpcc.meta.nvar * (bpmpcc.meta.nvar + 1) / 2
