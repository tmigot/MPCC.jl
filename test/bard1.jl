...
function MPCC.jac_nl_structure!(
  nlp::Bard1,
...
function MPCC.jac_nl_coord!(nlp::Bard1, x::AbstractVector, vals::AbstractVector)
  ...
  Jx = [-1.5 2.0 1.0 -0.5 1.0]
  vals[1:nlp.meta.nnzj] .= Jx[:]
  return vals
end

function MPCC.jacG_structure!(
  nlp::Bard1,
  rows::AbstractVector{<:Integer},
  cols::AbstractVector{<:Integer},
)
...
function MPCC.jnlprod!(nlp::Bard1, x::AbstractVector, v::AbstractVector, Jv::AbstractVector)
  ...
  Jv[1:nlp.meta.ncon] .= [-1.5 2.0 1.0 -0.5 1.0] * v
  return Jv
end

function MPCC.jnltprod!(
  nlp::Bard1,
  x::AbstractVector,
  v::AbstractVector,
  Jtv::AbstractVector,
  ...
  Jtv[1:nlp.meta.nvar] .= [-1.5 2.0 1.0 -0.5 1.0]' * v
  return Jtv
end
